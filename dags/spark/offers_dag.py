...
import sys
import logging
venv_path = '/u01/app/airflow/custom_venv/lib/python3.9/site-packages'
sys.path.insert(0, '/home/airflow/.local/lib/python3.9/site-packages/')
from openpyxl import load_workbook
sys.path.append(venv_path)



#IN_DIR = "/u01/app/airflow/dags/etlacrm/offers_input"
IN_DIR = '/data/mount/acrm_ext/import'
#OUT_DIR = "/u01/app/airflow/dags/etlacrm/offers_out"
OUT_DIR = '/data/mount/acrm_ext/importpg'
#FPROCED_DIR = "/u01/app/airflow/dags/etlacrm/processed"
FPROCED_DIR = '/data/mount/acrm_ext/processed'
...
def check_and_move_files(**kwargs):
    ...
    if files:
        ...
        for file_name in files:
            ...
            postgres_conn_id = 'postgr_acrm_dev'
...
#            connection.execute("""call gate.load_personal_offers();""")
